...
public class WhiteListDB {
	...
	public WhiteListDB(Context ctx) {                                   
		this.mCtx = ctx;
	}
	...
	public WhiteListDB open() throws android.database.SQLException {
	...
	// Add new Entry
	//
	public long createWhiteListEntry(String title, String mode, String reminderDateTime) {                                         
	...
	public Cursor fetchAllNumberss() {                                    
	...
	public boolean updateEntry(long rowId, String title, String mode, String 
			reminderDateTime) {                                         
